        ...
        <div className='container mx-auto py-4 flex flex-col md:flex-row space-x-2'>
          ...
          <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
            ...
            <div className='absolute top-16 left-8'>
              <p className='text-gray-600 mb-4'>Pradeep Codes</p>
              <h2 className='text-3xl font-bold'>WELCOME TO MY E-COMM SHOP</h2>
              <p className='text-xl mt-2.5 font-bold text-gray-800'>CHOOSE FROM THOUSANDS OF PRODUCTS</p>
